...
SQLite is always compiled in — every build of this binary has it, `--no-default-features` included. Postgres is the one remaining compile-time choice, on by default:
